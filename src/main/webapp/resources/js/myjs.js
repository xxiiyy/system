 ...
 * 节点更新
 */
var updateNodes = function (roleType) {
    nodess = "";
    getNodes();
    $.ajax({  //JQuery的Ajax
        type: 'post',
        ...
        url: "/blogSystem/role/updateNodes/" + roleType,//请求的action路径
 ...
 * @param roleType
 */
function initTree(roleType) {
    $.ajax({  //JQuery的Ajax
        type: 'POST',
        dataType: "json",//返回数据类型
        async: false,
        url: "/blogSystem/role/menus/"+roleType,//请求的action路径
